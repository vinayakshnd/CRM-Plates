...
{      
	...
	if (phone.length==10) 
		...
		{           
			...
			document.forms["crmaddclient"]["client_phn"].value="";
			return false;        
		}    
}
function isChar(evt) 
...
{      
	...
	var phone=document.forms["crmaddclient"]["guaranter_phn"].value;
	...
	if (phone.length==10) 
		...
		{           
			...
			document.forms["crmaddclient"]["guaranter_phn"].value="";
			return false;        
		}    
}
...
function validate1()
{
	var client_name=document.forms["crmaddclient"]["client_name"].value;
	var client_add=document.forms["crmaddclient"]["client_add"].value;
	var client_phn=document.forms["crmaddclient"]["client_phn"].value;
	var client_site=document.forms["crmaddclient"]["client_site_add"].value;
	var guaranter_name=document.forms["crmaddclient"]["guaranter_name"].value;
	var guaranter_phn=document.forms["crmaddclient"]["guaranter_phn"].value;
