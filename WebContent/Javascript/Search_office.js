...
function isphone()
{      
	 var phone=document.forms["crmmodifyoffice"]["office_phn"].value;
	...
	if (phone.length==10) 
		...
		{           
			...
			document.forms["crmmodifyoffice"]["office_phn"].value="";
			return false;        
		}    
}
...
function validate1()
{
	...
	var phone=document.forms["crmmodifyoffice"]["office_phn"].value;
	var address=document.forms["crmmodifyoffice"]["office_add"].value;
	var name=document.forms["crmmodifyoffice"]["office_name"].value;
	var flag=0;
