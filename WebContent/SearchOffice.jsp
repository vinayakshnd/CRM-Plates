...
<head>
<script type="text/javascript" src="Javascript/Search_office.js"></script>
        ...
        <script>
            $(document).ready(function() {      
                ...
                $('#Office_Id').change(function(event) {  
                	alert("comes to the javascript to check");
                	var username=$('#Office_Id').val();
                    if(username=="Selected")
                    	{
                    	$('#welcometext').html("<input type='hidden' value=''");
                    	}
                    else{
                 $.post('SearchOfficeAjax',{office_id:username},function(responseText) { 
