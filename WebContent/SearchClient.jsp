...
<html>
<head>
<script type="text/javascript" src="Javascript/Search_Client.js"></script>
        ...
        <script>
            $(document).ready(function() {                        
                $('#client_id').change(function(event) {  
                 ...
                 $.post('SearchClientAjax',{client_id:username},function(responseText) { 
...
<select id="client_id">
						...
						<c:forEach var="cust" items="${result1.rows}">
							<option value='<c:out value="${cust.client_id}"/>'>
								${cust.client_name}
							</option>
						</c:forEach>
				</select>	
